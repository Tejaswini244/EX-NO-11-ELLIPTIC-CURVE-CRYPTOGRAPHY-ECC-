...
int main() {
    ...
    printf("Enter yashu's private key: ");
    scanf("%lld", &privateA);
    printf("Enter teju's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("yashu's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("teju's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by yashu: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by teju: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
Enter the curve parameters (a and b) for equation y^2 = x^3 + ax + b: 7 5
Enter the base point G (x and y): 2 4
Enter yashu's private key: 27
Enter teju's private key: 55
yashu's public key: (0, 1)
teju's public key: (0, 1)
Shared secret computed by yashu: (7, 3)
Shared secret computed by teju: (7, 3)
